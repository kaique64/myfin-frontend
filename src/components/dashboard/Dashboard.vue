...
<template>
  <CardContainer>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-6">
      <CardInfo :title="texts.dashboard.currentBalance" :value="320" variant="info" />
      <CardInfo :title="texts.dashboard.income" :value="15000" variant="success" />
      <CardInfo :title="texts.dashboard.expenses" :value="12" variant="danger" />
    </div>
